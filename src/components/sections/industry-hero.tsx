        ...
        <div className="relative min-h-160 flex items-end">
          <div className="container pt-16 pb-10 flex items-end justify-between gap-8">
            ...
            <div className="max-w-131 flex flex-col gap-1.5">
              <p className="text-stone-300 text-sm font-normal font-montserrat leading-5 line-clamp-3">
                {description}
              </p>
              <button
                type="button"
                onClick={() => setOpen(true)}
                className="self-start text-stone-300 text-sm font-normal font-montserrat leading-5 underline underline-offset-2 hover:text-white transition-colors duration-150"
              >
                Read more
              </button>
            </div>
