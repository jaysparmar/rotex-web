...
await page.screenshot({ path: path.join(shotDir, "preview-step.png") });

// Try commit
const commitBtn = page.locator('button:has-text("Commit"), button:has-text("Import")').last();
console.log("commit-ish buttons:", await page.locator('button').allTextContents());
await page.waitForTimeout(300);
